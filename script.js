(() => {
  ...
  const photoCard = document.getElementById('photo3dCard');
  if (photoCard) {
    let rotation = 0;
    let velocity = 0;
    let dragging = false;
    ...
    photoCard.addEventListener('pointerdown', onPointerDown);
    photoCard.addEventListener('pointermove', onPointerMove);
    ...
    photoCard.closest('.photo3d').addEventListener('mouseenter', () => { idleSpin = false; });
    photoCard.closest('.photo3d').addEventListener('mouseleave', () => {
